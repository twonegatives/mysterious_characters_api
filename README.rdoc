== Mysterious Character Designer API

This project is an API for Users who want to share their fictional characters (e.g. superheroes, monsters and so on) and get feedback on them from others.

Here are the initial assesment requirements that had to be fulfilled during the challenge:
